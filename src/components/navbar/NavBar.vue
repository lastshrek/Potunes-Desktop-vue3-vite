 ...
 * @LastEditTime : 2023-09-03 11:43:35
...
-->
<template>
  <div class="flex bg-black w-full h-14 items-center justify-between bar px-20">
    <!-- navigator button -->
    <div class="flex">
      <ChevronLeftIcon class="h-10 w-10 py-1 px-2 text-2xl rounded-full hover:bg-album-hover" @click="go('back')" />
      <ChevronRightIcon class="h-10 w-10 py-1 ml-2 px-2 text-2xl rounded-full hover:bg-album-hover"
        @click="go('forward')" />
    </div>
    <!-- middle navigator -->
    ...
    <!-- user profile -->
    <div class="">
      <button class="hover:bg-albumcardhover text-white py-2 px-4 rounded text-sm" @click="go('login')"
