  ...
  <div
    ...
    <div class="flex items-center overflow-hidden w-full h-full justify-start flex-1">
      ...
      <div class="ml-3 flex flex-col" @click="showLyrics">
        ...
        <div v-text="currentTrack.artist"
          class="text-xs text-gray-400 overflow-hidden whitespace-nowrap overflow-ellipsis"></div>
      </div>
    </div>
    <!-- control panel -->
    <div class="flex flex-col justify-center h-full w-full flex-1">
      <vue-slider :min="0" :interval="0.01" :drag-on-click="true" :duration="0" :dot-size="12" :height="3"
        :tooltip="'none'" :lazy="true" @drag-end="dragEnd" v-model="value" contain ref="progress"
        class="h-3 mx-8 mt-1 bar"></vue-slider>

      <div class="flex justify-center items-center space-x-4">
        <!-- 循环 -->
        <button @click="repeatMode"
          class="px-2 w-10 h-10 flex justify-center items-center rounded-full hover:bg-albumcardhover">
          <svg t="1691598118430" v-if="this.modeType === 0 || this.modeType === 2" class="icon" viewBox="0 0 1024 1024"
            version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7057" width="24" height="24">
            <path
              ...
              p-id="7058" fill="#ffffff"></path>
          </svg>
          <svg t="1691598177672" v-else class="icon" viewBox="0 0 1024 1024" version="1.1"
            xmlns="http://www.w3.org/2000/svg" p-id="7323" width="24" height="24">
            <path
              d="M361.5 727.8c-119.1 0-215.9-96.9-215.9-215.9 0-119.1 96.9-215.9 215.9-215.9 2.3 0 4.6-0.2 6.8-0.6v58.3c0 12.3 14 19.4 23.9 12.1l132.6-97.6c8.1-6 8.1-18.2 0-24.2l-132.6-97.6c-9.9-7.3-23.9-0.2-23.9 12.1v58.1c-2.2-0.4-4.5-0.6-6.8-0.6-39.8 0-78.5 7.9-115 23.4-35.2 15-66.8 36.3-94 63.5s-48.6 58.8-63.5 94c-15.5 36.5-23.4 75.2-23.4 115s7.9 78.5 23.4 115c15 35.2 36.3 66.8 63.5 94s58.8 48.6 94 63.5c36.5 15.5 75.2 23.4 115 23.4 22.1 0 40-17.9 40-40s-17.9-40-40-40zM938.2 396.9c-15-35.2-36.3-66.8-63.5-94s-58.8-48.6-94-63.5c-36.5-15.5-75.2-23.4-115-23.4-22.1 0-40 17.9-40 40s17.9 40 40 40c119.1 0 215.9 96.9 215.9 215.9 0 119.1-96.9 215.9-215.9 215.9-4.1 0-8.1 0.6-11.8 1.8v-60.8c0-12.3-14-19.4-23.9-12.1l-132.6 97.6c-8.1 6-8.1 18.2 0 24.2L629.9 876c9.9 7.3 23.9 0.2 23.9-12.1V806c3.7 1.2 7.7 1.8 11.8 1.8 39.8 0 78.5-7.9 115-23.4 35.2-15 66.8-36.3 94-63.5s48.6-58.8 63.5-94c15.5-36.5 23.4-75.2 23.4-115s-7.8-78.5-23.3-115z"
        ...
        <button @click="prev"
          class="px-2 w-10 h-10 flex justify-center items-center rounded-full hover:bg-albumcardhover">
          <svg t="1691598810697" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="2975" width="24" height="24">
            <path
        ...
        <!-- 暂停/播放 -->
        <button ref="play" @click="play"
          class="px-2 w-10 h-10 flex justify-center items-center rounded-full hover:bg-albumcardhover">
          <svg t="1691599025349" v-if="!isPlaying" class="icon" viewBox="0 0 1024 1024" version="1.1"
            xmlns="http://www.w3.org/2000/svg" p-id="3841" width="24" height="24">
            <path
              ...
              fill="#ffffff" p-id="3842"></path>
          </svg>
          <svg t="1691599172430" v-else class="icon" viewBox="0 0 1024 1024" version="1.1"
            xmlns="http://www.w3.org/2000/svg" p-id="6673" width="24" height="24">
            <path
              ...
              fill="#ffffff" p-id="6674"></path>
          </svg>
        </button>
        <!-- 下一首 -->
        <button @click="next"
          class="px-2 w-10 h-10 flex justify-center items-center rounded-full hover:bg-albumcardhover">
          <svg t="1691598713799" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="14070" id="mx_n_1691598713799" width="24" height="24">
            <path
              ...
              fill="#ffffff" p-id="14071"></path>
          </svg>
        </button>
        <!-- 随机 -->
        <button @click="shuffle"
          class="px-2 w-10 h-10 flex justify-center items-center rounded-full hover:bg-albumcardhover">
          <svg v-if="this.modeType !== 2" t="1691599262562" class="icon" viewBox="0 0 1024 1024" version="1.1"
            xmlns="http://www.w3.org/2000/svg" p-id="7775" width="24" height="24">
            <path
              ...
              fill="#ffffff" p-id="7776"></path>
          </svg>
          <svg v-else class="w-6 h-6 text-pink-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
            viewBox="0 0 20 18">
    ...
    <div class="flex items-center justify-end h-full w-full pr-4 space-x-4 flex-1">
      ...
      <div class="flex flex-col items-center justify-center">
        <button icon @click="showNowPlayingList"
          class="px-2 w-10 h-10 flex justify-center items-center rounded-full hover:bg-albumcardhover">
          <svg class="w-6 h-6 text-gray-50" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
            viewBox="0 0 18 16">
            <path
      ...
      <div class="flex flex-col items-center justify-center">
        <button @click="mute"
          class="px-2 w-10 h-10 flex justify-center items-center rounded-full hover:bg-albumcardhover">
          <svg v-if="volume > 0.5" class="w-6 h-6 text-gray-50" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
          ...
          <svg v-else-if="volume <= 0.5 && volume !== 0" class="w-6 h-6 text-gray-50" aria-hidden="true"
          ...
          <!-- 静音 -->
          <svg v-else class="w-6 h-6 text-gray-50" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="mx-2 items-center w-32 justify-center">
        <vue-slider v-model="volume" ref="volumeSlider" :min="0" :max="1" :interval="0.01" :drag-on-click="true"
          :duration="0" tooltip="none" :index="2" @drag-end="volumeChanged" :dot-size="10" class="bar"></vue-slider>
      </div>
      <div class="flex flex-col items-center justify-center">
        <button icon @click="showLyrics"
          class="px-2 w-10 h-10 flex justify-center items-center rounded-full hover:bg-albumcardhover">
          <svg t="1691597908372" class="w-4 h-4" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="1961" width="24" height="24">
            <path
